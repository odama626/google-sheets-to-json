...
(function (Category) {
    ...
    Category["Gyroids"] = "Gyroids";
    Category["Headwear"] = "Headwear";
    Category["Housewares"] = "Housewares";
    Category["InteriorStructures"] = "Interior Structures";
    Category["Miscellaneous"] = "Miscellaneous";
    Category["Music"] = "Music";
    Category["Other"] = "Other";
    Category["ParadisePlanning"] = "Paradise Planning";
...
var Type;
(function (Type) {
    Type["AcceEyeMouth"] = "AcceEyeMouth";
    Type["AccessoryEye"] = "AccessoryEye";
    Type["AccessoryEyeMouthInvisibleNose"] = "AccessoryEyeMouthInvisibleNose";
    Type["AccessoryMouth"] = "AccessoryMouth";
    Type["AccessoryMouthEarJaw"] = "AccessoryMouthEarJaw";
    Type["AccessoryMouthInvisibleNose"] = "AccessoryMouthInvisibleNose";
    Type["AccessoryOneEye"] = "AccessoryOneEye";
    Type["HeadCap"] = "HeadCap";
    Type["HeadFace"] = "HeadFace";
    Type["HeadFullFace"] = "HeadFullFace";
    Type["HeadHairOrnamentBack"] = "HeadHairOrnament_Back";
    Type["HeadHairOrnamentFront"] = "HeadHairOrnament_Front";
    Type["HeadHairOrnamentLeft"] = "HeadHairOrnament_Left";
    Type["HeadHairOrnamentPeak"] = "HeadHairOrnament_Peak";
    Type["HeadHairOrnamentTop"] = "HeadHairOrnament_Top";
    Type["HeadgearHasBang"] = "Headgear_HasBang";
    Type["HeadgearHasEar"] = "Headgear_HasEar";
    Type["HeadgearNoEar"] = "Headgear_NoEar";
    Type["HeadgearNoEarNoJaw"] = "Headgear_NoEarNoJaw";
...
(function (Source) {
    ...
    Source["CookPumpkin"] = "CookPumpkin";
    ...
    Source["OneRoomTailorKKFes"] = "OneRoomTailorKKFes";
...
var Theme;
(function (Theme) {
    Theme["AmusementPark"] = "amusement park";
    Theme["Ancient"] = "ancient";
    Theme["ApparelShop"] = "apparel shop";
    Theme["Arcade"] = "arcade";
    Theme["Bathroom"] = "bathroom";
    Theme["Caf\u00E9"] = "caf\u00E9";
    Theme["ChildSRoom"] = "child's room";
    Theme["CityLife"] = "city life";
    Theme["Concert"] = "concert";
    Theme["ConstructionSite"] = "construction site";
    Theme["Den"] = "den";
    Theme["European"] = "European";
    ...
    Theme["Space"] = "space";
    Theme["Sports"] = "sports";
    Theme["Stylish"] = "stylish";
    Theme["Supermarket"] = "supermarket";
